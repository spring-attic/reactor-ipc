[[getting-started]]
== *Introducing Reactor IO*

[quote, Preface, TL;DR]
Reactor IO is a foundational library for building demanding, over the wire *Data-Streaming* applications and micro,
nano, or
...
.html[Apache 2.0 licensed]. It is available on https://github.com/reactor/reactor-io[GitHub].
...
.The main modules present in Reactor IO