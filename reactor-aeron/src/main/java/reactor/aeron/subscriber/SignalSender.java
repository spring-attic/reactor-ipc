...
public class SignalSender {
	...
	public SignalSender(AeronInfra aeronInfra, Consumer<Throwable> errorConsumer) {
	 ...
	 */
	private long publishSignal(Publication publication, Buffer buffer, SignalType signalType, boolean retryPublication) {
	...
	public long publishSignal(String sessionId, Publication publication, Buffer buffer, SignalType signalType,
		...
		try {
			result = publishSignal(publication, buffer, signalType, retryPublication);
		} catch (Throwable t) {
